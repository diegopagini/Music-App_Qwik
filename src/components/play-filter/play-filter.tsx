...
export const PlayFilter = component$(({ label, values }: PlayFilterProp) => {
	...
	return (
		<div onClick$={handleFilter} class={'flex gap-1 text-gray-400 hover:text-gray-600 select-none'}>
			<span class={'uppercase font-medium text-sm  cursor-pointer'}>{label}</span>
			<span>
