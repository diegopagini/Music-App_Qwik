...
export const PlayListItem = component$((props: PlayListPropsWave) => {
	...
	return (
		<div class={'group'}>
			<div
				class={
					'group-hover:bg-white transition-all ease-out duration-75  cursor-pointer rounded-tl-full rounded-bl-full p-2 items-center flex'
				}>
				<div class={'flex gap-6 w-1/5'}>
					<div>
						<img class={'rounded-full h-[60px] w-[60px] object-cover'} src={props.cover} alt='' />
					</div>
