...
import { PlayListItem } from './player-list-item';
...
export const PlayListContext = createContext<PlayListContextProp>('play-list-context');
...
export const PlayList = component$(() => {
	...
	//TODO: Resource!
	const resourceData = useResource$(() => getData());
